...
typedef enum {A_simpleVar, A_fieldVar, A_subscriptVar} var_kind;
struct A_var_
{
	var_kind kind;
    A_pos pos;
...
typedef enum {A_varExp, A_nilExp, A_intExp, A_stringExp, A_callExp,
	...
	A_whileExp, A_forExp, A_breakExp, A_letExp, A_arrayExp} exp_kind;
...
typedef enum {A_functionDec, A_varDec, A_typeDec} dec_kind;
struct A_dec_
{
    dec_kind kind;
...
typedef enum {A_nameTy, A_recordTy, A_arrayTy} a_kind;
struct A_ty_
{
